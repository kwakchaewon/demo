...
public class TokenDto {
    ...
    public TokenDto(String accessToken, String refreshToken, Date accessExpired, Date refreshExpired, String userId, String authority) {
        Date now = new Date();
    ...
    public TokenDto(String accessToken, Date accessExpired, String userId, String authority) {
        Date now = new Date();
        this.accessToken = accessToken;
        this.accessTime = (float) (accessExpired.getTime() - now.getTime()) / (1000 * 60 * 60 * 24);
        this.memberId = userId;
